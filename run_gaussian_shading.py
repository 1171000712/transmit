...
def main(args):
    ...
    # class for watermark
    if args.chacha:
        #watermark = Image_Watermark(args.test_mode,  args.fpr, args.user_number)
        watermark =  Gaussian_Shading_Plus_chacha(args.channel_copy, args.hw_copy, args.fpr, args.user_number,mode)
    else:
        #a simple implement,
    ...
    for i in tqdm(range(args.num)):
        ...
        image_w.save('origin.png')
        # distortion
        image_w_distortion = image_distortion(image_w, seed, args)
        image_w_distortion.save('dist.png')
        # reverse img
